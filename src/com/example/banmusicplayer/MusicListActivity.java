...
public class MusicListActivity extends MyBaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (listName != null && !listName.equals("")) {
			...
			findViewById(R.id.a).setVisibility(View.GONE);// 毕竟复用，不用的时候要隐藏
		}
		...
		musicList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				startActivity(new Intent(MusicListActivity.this,
	...
	public boolean onContextItemSelected(MenuItem item) {
		...
		case 1:
			if (musicListNameMap.size() == 0) {
				Toast.makeText(this, "音乐列表个数为0,请去添加列表后再试", Toast.LENGTH_LONG)
						.show();
				break;
			}
